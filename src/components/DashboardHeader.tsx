    ...
    <div className="flex flex-col gap-6 mb-8">
      ...
      <div className="flex items-start justify-between gap-4">
        <div>
          ...
          <p className="text-sm text-gray-500 mt-0.5">Here&apos;s what is happening with your money.</p>
        </div>
      ...
      <div className="flex items-center justify-between">
        <span className="text-sm font-medium text-gray-600">{formattedMonth}</span>
        <div className="flex items-center gap-1 bg-gray-100 rounded-full p-1">
          ...
          <span className="text-sm font-medium w-32 text-center text-gray-700">{formattedMonth}</span>
          <Button
            variant="ghost"
            size="icon"
            className="h-7 w-7 hover:bg-white"
